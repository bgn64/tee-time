 ...
 * shared by the live scoring and edit screens.
 *
 * Header style B (bold green band): filled primary-dark band with
 * reversed-out white text and translucent-white chevron buttons. See
 * docs/scoring-ui-tweaks-mockups.html for the visual rationale.
 *
 * Chevrons disable at the holeNumber boundaries (1 and maxHole).
 */
