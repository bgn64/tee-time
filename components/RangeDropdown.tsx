 ...
 *
 * Renders a small floating menu anchored visually to a pill at the top
 * of the screen (implementation: full-screen Modal with a tap-to-
...
const OPTIONS: Array<{ value: HoleRange; label: string }> = [
