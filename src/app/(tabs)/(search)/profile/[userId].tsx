/**
 * Profile screen — `(tabs)/(search)/profile/[userId]`.
 *
 ...
 * (future: tap-to-view-profile from a scoring participant chip) can
 * mount the same component without going through this route.
 *
